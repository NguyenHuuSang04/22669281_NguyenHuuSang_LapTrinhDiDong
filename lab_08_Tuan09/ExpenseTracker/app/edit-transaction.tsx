...
import { getTransactionById, updateTransaction } from '@/lib/database';
...
export default function EditTransactionScreen() {
  ...
  const [originalCreatedAt, setOriginalCreatedAt] = useState<Date>(new Date());
  ...
  // Load transaction data khi component mount
  useEffect(() => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const updatedTransaction = {
        ...
        createdAt: originalCreatedAt // Giữ nguyên ngày tạo ban đầu
      };

      updateTransaction(id as string, updatedTransaction);
